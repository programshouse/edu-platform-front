    ...
    <div className="min-h-[calc(100vh-64px)] flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-linear-to-br from-blue-600 via-blue-700 to-indigo-800">
        ...
        <div className="absolute inset-0">
          <div className="absolute top-0 inset-e-0 w-96 h-96 bg-white/5 rounded-full -translate-y-1/2 translate-x-1/2" />
          <div className="absolute bottom-0 inset-s-0 w-80 h-80 bg-white/5 rounded-full translate-y-1/3 -translate-x-1/3" />
          <div className="absolute top-1/2 inset-s-1/2 w-64 h-64 bg-white/3 rounded-full -translate-x-1/2 -translate-y-1/2" />
          {/* Grid dots pattern */}
          <div
          ...
          >
            <div className="relative w-36 h-36 mx-auto">
              ...
              <img
                ...
                alt="Instructor"
                className="relative w-36 h-36 rounded-full object-cover ring-4 ring-white/30 shadow-2xl"
              />
            </div>
          </motion.div>
